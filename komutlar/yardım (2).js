...
exports.run = (client, message, args) => {
  ...
  let pages = [
              ...
              '**Müzik**\n\n\n' + '``-``  g!çal = Youtubeda İstediğiniz Bir Şarkıyı Aratır Ve Oynatır. \n``-``  g!duraklat = Oynatılan Şarkıyı Devam Etmek Üzere Durdurur. \n``-``  g!devam = Duraklatılan Şarkıyı Devam Ettir. \n``-``  g!geç = Oynatılan Şarkıyı Geçer. \n``-``  g!kuyruk = Kuyruk’ta Olan Müzikleri Gösterir. \n``-``  g!çalan = Oynatılan Müziği Gösterir. \n``-``  g!ses = Ses Seviyesini Ayarlarsınız.',
              '**Çerçeve/Profil**\n\n\n ' + '``-``  g!hacked = Profilinize ``hacked`` Efekti Verir. \n``-``  g!triggered = Profilinize ``triggered`` Efekti Verir. \n``-``  g!wasted = Profilinize ``wasted`` Efekti Verir. \n``-``  g!winner = Profilinize ``winner`` Efekti Verir. \n``-``  g!sniper = Profilinize ``sniper`` Efekti Verir. \n``-``  g!hpbalance = Profilinize ``hypesquad balance`` Efekti Verir. \n``-``  g!hpbravery = Profilinize ``hypesquad bravery`` Efekti Verir. \n``-``  g!hpbrilliance = Profilinize ``hypesquad brilliance`` Efekti Verilir. \n``-``  g!dcbughunter = Profilinize ``bug hunter`` Efekti Verir. \n``-``  g!hpevent = Profilinize ``hypesquad`` Efekti Verir. \n``-``  g!dcpartner = Profilinize ``partner`` Efekti Verir. \n``-``  g!dcstaff = Profilinize ``staff`` Efekti Verir. \n``-``  g!atatürk = Profilinize ``atatürk`` Efekti Verir.',
